...
public class NoteActivity2 extends Activity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if(extras == null) {
                ...
                newString= extras.getString("car");
            }
        } else {
            newString= (String) savedInstanceState.getSerializable("car");
        }

        //tts = new TextToSpeech(this, this);

        //btnSpeak = (ImageButton) findViewById(R.id.speechButt2);
...
/*        btnSpeak.setOnClickListener(new View.OnClickListener() {
        ...
        readyText = (TextView) findViewById(R.id.ready_text2);
...
//        Log.i("carac",newString);
        ...
        inkView = (InkView2) findViewById(R.id.ink_view2);
       ...
       /* Display defaultDisplay = getWindowManager().getDefaultDisplay();
        ...
        // Log.i("fff","aaa");
        Intent in = new Intent(NoteActivity2.this, RecognizerService.class);
    ...
    private void saveAlertDialog(boolean isChanged) {
        ...
        final Intent in = new Intent(NoteActivity2.this, AllNote.class);
        if (isChanged) {
            final AlertDialog alert;

            AlertDialog.Builder dialog2 = new AlertDialog.Builder(NoteActivity2.this);
            ...
            alert.setButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Save();
                    startActivity(in);
                    NoteActivity2.this.overridePendingTransition(R.anim.from_right,
                            R.anim.to_left);
                    finish();
                }
            });
    ...
    private class trait extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            progress = new ProgressDialog(NoteActivity2.this);
