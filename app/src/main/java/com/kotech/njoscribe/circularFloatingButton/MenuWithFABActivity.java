...
import com.library.animation.FloatingActionButton;
import com.library.animation.FloatingActionMenu;
import com.library.animation.SubActionButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(MenuWithFABActivity.this, MenuWithFABActivity.class);
                startActivity(i);
            }
        });
       ...
       final ImageView fabIconNew = new ImageView(this);
        ...
        fabIconStar.setImageDrawable(getResources().getDrawable(R.drawable.settings2));
        ...
        lcIcon2.setImageDrawable(getResources().getDrawable(R.drawable.info));
        lcIcon3.setImageDrawable(getResources().getDrawable(R.drawable.langues));
        lcIcon4.setImageDrawable(getResources().getDrawable(R.drawable.music));
        lcIcon5.setImageDrawable(getResources().getDrawable(R.drawable.speaker));
