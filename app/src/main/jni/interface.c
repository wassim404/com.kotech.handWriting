...
jint Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_recognizerInit( JNIEnv* env, jobject thiz, jstring jpath, jint nLanguage ) 
{
...
jboolean  Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_resetLearner( JNIEnv* env)
{
...
jboolean  Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_reloadLearner( JNIEnv* env)
{
	if (_recognizer != NULL  && _szPath[0] != 0 )
    {
		char learner[MAX_PATH];
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_saveLearner( JNIEnv* env)
{
	if (_recognizer != NULL  && _szPath[0] != 0 )
    {
		char learner[MAX_PATH];
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_resetAutocorrector( JNIEnv* env) 
{
	if (_recognizer != NULL  && _szPath[0] != 0 )
    {
		char corrector[MAX_PATH];
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_reloadAutocorrector( JNIEnv* env) 
{
	if (_recognizer != NULL && _szPath[0] != 0 )
    {
		char corrector[MAX_PATH];
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_saveWordList( JNIEnv* env)
{
	if (_recognizer != NULL && _szPath[0] != 0 )
    {
		char corrector[MAX_PATH];
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_resetUserDict( JNIEnv* env) 
{
	if (_recognizer != NULL && _szPath[0] != 0 )
    {
		char userDict[MAX_PATH];
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_reloadUserDict( JNIEnv* env)
{
	if (_recognizer != NULL && _szPath[0] != 0 )
    {
		char userDict[MAX_PATH];
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_isPointStroke( JNIEnv* env, jobject thiz, jint nStroke )
{
	if ( _inkData != NULL )
	{
		CGRect rect = {0,0,0,0};
...
jint Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_checkStrokeNewLine( JNIEnv* env, jobject thiz, jint nStroke )
{
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_saveUserDict( JNIEnv* env)
{
	if (_recognizer != NULL) {
		char userDict[MAX_PATH];
		userDict[0] = 0;
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_setDictionaryData(
...
void Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_freeRecognizer( JNIEnv* env)
{
	if (_recognizer != NULL)
    {
        if ( _szPath[0] == 0 )
...
jint  Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_getRecognizerFlags( JNIEnv * env)
{
	jint result = 0;
	if (_recognizer != NULL) {
...
void Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_setRecognizerFlags( JNIEnv * env, jobject thiz, jint flags)
{
	if (_recognizer != NULL) {
...
jint Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_getRecognizerMode( JNIEnv * env) 
{
	jint result = 0;
	if (_recognizer != NULL) {
...
void Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_setRecognizerMode( JNIEnv * env, jobject thiz, jint mode)
{
	if (_recognizer != NULL) {
...
void Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_stopRecognizer( JNIEnv* env)
{
	if (_recognizer != NULL) {
...
jstring Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_recognizeInkData(
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_preRecognizeInkData( JNIEnv* env, jobject thiz, jint nDataLen) 
{
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_newStroke( JNIEnv * env, jobject thiz, jint width, jint color)
{
	jint result = -1;
	if (NULL != _inkData) {
...
jint Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_getStrokeCount( JNIEnv * env) 
{
	jint result = -1;
	if (NULL != _inkData) {
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_deleteLastStroke( JNIEnv * env) 
{
	jboolean result = false;
	if (NULL != _inkData) {
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_deleteStroke( JNIEnv * env, jobject thiz, jint nStroke )
{
	jboolean result = false;
	if (NULL != _inkData) {
...
jint Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_detectGesture( JNIEnv* env, jobject thiz, jint type) 
{
...
jint Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_addPixelToStroke(
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_resetRecognizer(JNIEnv * env) 
{
	if (NULL != _recognizer) {
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_resetInkData(JNIEnv * env)
{
	if (NULL != _inkData) {
		INK_Erase(_inkData);
		_currentStroke = -1;
...
jstring Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_languageName(JNIEnv* env, jobject thiz) 
{
	jstring result = NULL;
    if (NULL != _recognizer) {
...
jint Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_languageID( JNIEnv * env) 
{
    if (NULL != _recognizer) {
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_newUserDict(JNIEnv * env) 
{
	if (NULL != _recognizer) {
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_addWordToUserDict( JNIEnv * env, jobject thiz, jstring jword) 
{
	jboolean result = false;
	if (NULL != _recognizer)
    {
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_resetResult( JNIEnv * env, jobject thiz)
{
	jboolean result = false;
	if (NULL != _recognizer) {
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_isWordInDict(JNIEnv * env, jobject thiz, jstring jword) 
{
	jboolean result = false;
	if (_recognizer != NULL) {
...
jint Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_getResultColumnCount(JNIEnv * env, jobject thiz) 
{
	jint result = 0;
	if (NULL != _recognizer) {
...
jint Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_getResultRowCount(JNIEnv * env, jobject thiz, jint col) 
{
	jint result = 0;
	if (NULL != _recognizer) {
...
jstring Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_getRecognizedWord(JNIEnv * env, jobject thiz, jint col, jint row) 
{
	jstring result = NULL;
	if (NULL != _recognizer)
    {
...
jstring Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_getAutocorrectorWord( JNIEnv * env, jobject thiz, jstring inWord)
{
	jstring result = NULL;
	if (_recognizer != NULL)
    {
...
jint Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_getRecognizedWeight( JNIEnv * env, jobject thiz, jint col, jint row)
{
	jint result = 0;
	if (NULL != _recognizer) {
...
jint Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_getResultStrokesNumber( JNIEnv * env, jobject thiz, jint col, jint row)
{
	jint result = 0;
	if (NULL != _recognizer) {
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_learnerAddNewWord( JNIEnv * env, jobject thiz, jstring jword, jint weight) 
{
	jboolean result = false;
	if (NULL != _recognizer) {
		const UCHR * word = JstringToString(env, jword);
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_learnerReplaceWord( 
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_autocorrectorLearnWord(
...
jstring Java_com.kotech.njoscribe_writepad_WritePadAPI_spellCheckWord(JNIEnv * env, jobject thiz, jstring jword, jboolean showlist )
{
    const UCHR * strWord = JstringToString(env, jword);
    if (strWord == NULL)
    {
...
jboolean  Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_exportWordList(JNIEnv* env, jobject thiz, jstring pExportFile)
{
    jboolean result = false;
	if (_recognizer != NULL)
    {
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_exportUserDictionary(JNIEnv* env, jobject thiz, jstring pExportFile)
{
    jboolean result = false;
	if (_recognizer != NULL)
    {
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_importWordList(JNIEnv* env, jobject thiz, jstring pImportFile)
{
    jboolean result = false;
	if (_recognizer != NULL)
    {
...
jboolean Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_importUserDictionary(JNIEnv* env, jobject thiz, jstring pImportFile)
{
    jboolean result = false;
	if (_recognizer != NULL)
    {
...
static const char *kInterfacePath = "com.kotech.njoscribe/RecoInterface/WritePadAPI";
...
jint Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_getEnumUserWordsList( JNIEnv * env, jobject thiz, void * param) 
{
	jint result = 0;
	if (NULL != _recognizer) {
        interfaceClass = NULL;
...
jint Java_com.kotech.njoscribe_RecoInterface_WritePadAPI_getEnumWordList( JNIEnv * env, jobject thiz, void * param) 
{
	jint result = 0;
	if (NULL != _recognizer) {
        interfaceClass = NULL;
